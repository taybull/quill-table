(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["quillTable"] = factory();
	else
		root["quillTable"] = factory();
})(this, function() {
...
var _TableCellBlot = __webpack_require__(40);
...
var _quillDelta = __webpack_require__(63);
...
var _TableRowBlot = __webpack_require__(55);

var _TableRowBlot2 = _interopRequireDefault(_TableRowBlot);

var _TableBlot = __webpack_require__(114);
...
var TableModule = function TableModule(quill, options) {
    ...
    clipboard.addMatcher('TD', function (node, delta) {
        return delta.compose(new _quillDelta2.default().retain(delta.length(), { td: node.getAttribute('table_id') + '|' + node.getAttribute('row_id') + '|' + node.getAttribute('cell_id') }));
    });
};
...
var equal = __webpack_require__(38);
var extend = __webpack_require__(39);
var op = __webpack_require__(67);
